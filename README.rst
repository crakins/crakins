...
.. code-block:: bash
    ...
    heroku run python crakins/manage.py syncdb --noinput --settings=config.settings
    heroku run python crakins/manage.py migrate --settings=config.settings
    heroku run python crakins/manage.py collectstatic --settings=config.settings
